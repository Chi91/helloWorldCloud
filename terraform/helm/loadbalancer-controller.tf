...
module "irsa_alb_ingress_controller" {
  ...
  create_role                   = true
  role_name                     = "alb-ingress-controller-iam-role"
...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  # Attach iam role with service account
  set {
...
#Define specifc policy for lb
resource "aws_iam_policy" "my_custom_policy" {
  name        = "MyCustomALBIngressPolicy"
  description = "A customize IAM-Policy for ALB Ingress Controller."
